boardGame <- function() {
  ...
  exp_val <- v[1]*(1*(1/18)) + v[2]*(1*(1/18)) + v[3]*(1*(4/18)) + v[5]*(1*(3/6)) + v[6]*((1*(3/6))+(2*(1/18))) + v[7]*((1*(4/6))+(2*(1/18))) + v[8]*((1*(5/6))+(2*(1/18)))
  exp_val_squared <- (v[1]*(1^2*(1/18)) + v[2]*(1^2*(1/18)) + v[3]*(1^2*(4/18)) + v[5]*(1^2*(3/6)) + v[6]*((1^2*(3/6))+(2^2*(1/18))) + v[7]*((1^2*(4/6))+(2^2*(1/18))) + v[8]*((1^2*(5/6))+(2^2*(1/18))))
