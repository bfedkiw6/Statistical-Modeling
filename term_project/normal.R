...
hist(norm_data, probability=TRUE,main='Density Estimates of MLB Weight', xlab='Credit Score')
...
curve(dnorm(x,MM_norm_mu,MM_norm_sigma), from=0, to=900, col='red', main='Density Estimates of MLB Weight with MM', xlab='Credit Score', ylab='Density')
lines(density(norm_data), col='blue')
dev.off()
...
curve(dnorm(x,MLE_norm_mu,MLE_norm_sigma), from=0, to=900, col='red', main='Density Estimates of MLB Weight with MLE', xlab='Credit Score', ylab='Density')
lines(density(norm_data), col='blue')
dev.off()
