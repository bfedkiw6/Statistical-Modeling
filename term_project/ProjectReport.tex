...
\author{\\ Ethan Wang, Briana Fedkiw}
\date{}
\pagestyle{fancy}
...
\newpage
\noindent
In both the MM and MLE estimation methods, the values for $\mu$ and $\sigma$ were fairly close to one another. When looking at a normal distribution, one looks at the parameters of population mean and variance, $\mu$ and $\sigma^2$. From the data, the mean is $156.1726$ and the variance is $ 8.62219^2 \approx 74.34216$. Both our MM and MLE estimation methods had values of $\mu$ and $\sigma^2$ extremely close or even the same as the dataset. When looking at bias, the amount was very small. For MM, the amount of bias for $\mu$ was $\approx 0$ and for $\sigma$ was $\approx 0.000045$. For MLE, the amount of bias for $\mu$ was $\approx 0.0001$ and for $\sigma$ was $\approx 0.000267$. The small amount of bias is an indicator that this dataset follows a normal distribution. \\
...
Briana Fedkiw
\begin{itemize}[leftmargin=50pt]
  \item Normal distributions (data and analysis)
